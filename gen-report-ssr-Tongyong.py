"""生成td3_ssr_通用的学术论文级HTML训练报告 -"""
import json, scipy.io as sio, numpy as np, csv

mat_dir = 'data/storage/uav_bs_fas/scratch/td3_ssr_XX'
...
<head>
<meta charset="UTF-8">
<title>FAS-UAV保密通信TD3训练报告 (td3_ssr_3)</title>
...
<div class="title-block">
  ...
  <div class="subtitle">FAS-Assisted UAV Secure Communication System &mdash; Twin Delayed TD3 Training Report (td3_ssr_3)</div>
  <div class="meta">奖励函数: SSR (保密速率) &nbsp;|&nbsp; 训练轮次: ''' + str(len(episodes)) + ''' &nbsp;|&nbsp; 每轮步数: 100 &nbsp;|&nbsp; FAS同时激活端口: 2</div>
</div>
<div class="summary">
...
<div class="tbl-section">
  <table>
    ...
    <tr><th>指标</th><th>Episode 0</th><th>Episode 10</th><th>Episode 25</th><th>Episode 49</th></tr>
    ''' + rows_html + '''
  </table>
</div>
<div class="footer">FAS-UAV Secure Communication &mdash; TD3 Reinforcement Learning Training Report (td3_ssr_4)</div>
<script>
...
Plotly.newPlot('c_reward', [
  ...
  yaxis:{title:{text:'奖励 (Reward/SSR)',font:{size:13}},tickfont:{size:11},gridcolor:'#eee'}
}));
...
out_path = f'{mat_dir}/training_report_ssr3.html'
