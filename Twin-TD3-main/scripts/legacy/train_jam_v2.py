"""v18: 修正干扰模型 - 放大热噪声 + 信道对齐干扰相位"""
import os, sys, csv, glob
os.environ["KMP_DUPLICATE_LIB_OK"] = "TRUE"
sys.stdout.reconfigure(line_buffering=True)
sys.argv = ['train_jam_v2.py', '--drl', 'td3', '--reward', 'see']
...
system = MiniSystem(
    user_num=2, RIS_ant_num=8, UAV_ant_num=4, if_dir_link=1,
...
agent_1 = Agent(alpha=3e-4, beta=3e-3, input_dims=[77], tau=5e-4,
    ...
    layer3_size=256, layer4_size=128, n_actions=48, max_size=500000,
...
print("v5: 8-element RIS + no scheduling + heuristic-only phases")
...
agent_1.save_models(); agent_2.save_models()
print(f"v18 training done. Total: {ep} episodes")
