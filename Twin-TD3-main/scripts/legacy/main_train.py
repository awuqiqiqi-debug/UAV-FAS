...
# Agent 2 状态 = UAV坐标(3) + RIS坐标(3) + User0坐标(3) + User1坐标(3) = 12维
_agent2_state_dim = 3 + 3 + system.user_num * 3
agent_2_param_dic["input_dims"] = _agent2_state_dim
