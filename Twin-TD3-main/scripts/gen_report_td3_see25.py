"""生成td3_see_25的学术论文级HTML训练报告"""
import json, scipy.io as sio, numpy as np, os, csv

mat_dir = 'data/storage/uav_bs_fas/scratch/td3_see_25'
...
<head>
<meta charset="UTF-8">
<title>FAS-UAV保密通信TD3训练报告 (td3_see_25)</title>
...
<div class="title-block">
  ...
  <div class="subtitle">FAS-Assisted UAV Secure Communication System &mdash; Twin Delayed TD3 Training Report (td3_see_25)</div>
  <div class="meta">奖励函数: 改进版(距离引导+窃听者抑制) &nbsp;|&nbsp; 训练轮次: 350 &nbsp;|&nbsp; 每轮步数: 100</div>
</div>
...
<div class="footer">FAS-UAV Secure Communication &mdash; TD3 Reinforcement Learning Training Report (td3_see_25)</div>
