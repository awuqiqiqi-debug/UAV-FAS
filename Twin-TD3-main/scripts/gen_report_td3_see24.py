"""生成td3_see_24的学术论文级HTML训练报告"""
import re, json, scipy.io as sio, numpy as np, os

mat_dir = 'data/storage/uav_bs_fas/scratch/td3_see_24'

# Read training log
log_path = r'C:\Users\红\AppData\Local\Temp\claude\c--Users---Desktop-0606-------------------------\316034bc-bb48-4979-8ee6-bb92067f2cce\tasks\bx1rv9vq8.output'
episodes, scores = [], []
