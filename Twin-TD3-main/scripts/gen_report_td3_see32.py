"""生成td3_see_32的学术论文级HTML训练报告"""
import json, scipy.io as sio, numpy as np, csv

mat_dir = 'data/storage/uav_bs_fas/scratch/td3_see_32'
...
<head>
<meta charset="UTF-8">
<title>FAS-UAV保密通信TD3训练报告 (td3_see_32)</title>
...
<div class="title-block">
  ...
  <div class="subtitle">FAS-Assisted UAV Secure Communication System &mdash; Twin Delayed TD3 Training Report (td3_see_32)</div>
  <div class="meta">奖励函数: 合理设计版(保密速率+距离引导+FAS增益) &nbsp;|&nbsp; 训练轮次: 1000 &nbsp;|&nbsp; 每轮步数: 100</div>
</div>
...
<div class="footer">FAS-UAV Secure Communication &mdash; TD3 Reinforcement Learning Training Report (td3_see_32)</div>
