"""Generate all plots for td3_mfris_jam_v1 (1000 episodes)"""
import matplotlib
matplotlib.use('Agg')
...
path = 'data/storage/scratch/td3_mfris_jam_v1'
...
ax.set_title('UAV Trajectory - Jamming Optimization (1000 eps)', color='#60a5fa', fontsize=14, pad=15)
...
if os.path.exists(f_last):
    ...
    for elem in range(4):
        ...
        ax.set_title(f'RIS Element #{elem} Phase & Magnitude (ep 1000)', color='#93c5fd', fontsize=12, pad=10)
